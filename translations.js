const translations = {
    en: {
        ...
        'matches-coming-soon': 'Matches Coming Soon',
        'season-records': 'Match records for the',
        'season-coming': 'season are coming soon.',

        // Match Modal
        'modal-details': 'DETAILS',
        'modal-goals': 'GOALS',
        'modal-lineup': 'LINE-UP',
        ...
        'tickets-coming': 'Tickets Coming Soon',
        'tickets-desc': 'Ticketing services will be available soon. Stay tuned for updates on how to get your match tickets.',
        ...
        'contact': 'CONTACT',
        'contact-desc': 'Get in touch with us for general enquiries about the club, partnerships, or supporter information.',

        // Footer
        'footer-tagline': 'Professional Amateur Football',
        'footer-club': 'CLUB',
    ...
    ar: {
        ...
        'matches-coming-soon': 'المباريات قريباً',
        'season-records': 'سجلات مباريات',
        'season-coming': 'قادمة قريباً.',

        // Match Modal
        'modal-details': 'التفاصيل',
        'modal-goals': 'الأهداف',
        'modal-lineup': 'التشكيلة',
        ...
        'tickets-coming': 'التذاكر قريباً',
        'tickets-desc': 'ستتاح خدمات التذاكر قريباً. ترقب آخر التحديثات حول كيفية الحصول على تذاكرك.',
        ...
        'contact': 'اتصل',
        'contact-desc': 'تواصل معنا للاستفسارات العامة عن النادي أو الشراكات أو معلومات المشجعين.',

        // Footer
        'footer-tagline': 'نادي كرة قدم هاوي احترافي',
        'footer-club': 'النادي',
        'footer-about': 'عن النادي',
        'footer-contact': 'اتصل',
        'footer-football': 'كرة القدم',
